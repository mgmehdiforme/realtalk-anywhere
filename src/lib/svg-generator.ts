/**
 * ─────────────────────────────────────────────────────────────────────────────
 * BRANDED DARK-MODE BLOG HERO SVG GENERATOR (1200x630px)
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
export function buildBrandedBlogHeroSvg(
  ...
  const cleanTitle = title || "Technical Architecture & Systems Engineering";
  const cleanTag = (categoryTag || "Architecture").toUpperCase();
...
<svg width="1200" height="630" viewBox="0 0 1200 630" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(80, 175)">
    <rect width="${Math.max(cleanTag.length * 10 + 32, 130)}" height="32" rx="16" fill="rgba(99, 102, 241, 0.15)" stroke="rgba(99, 102, 241, 0.4)" stroke-width="1" />
    <text x="16" y="20" font-family="ui-monospace, monospace" font-size="12" font-weight="700" fill="#38bdf8" letter-spacing="1">
      ${escapeXml(cleanTag)}
    </text>
  </g>
