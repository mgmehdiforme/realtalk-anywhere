...
function LandingPage({ 
  ...
  return (
    <div className="bg-background">
      ...
      {/* Login / Get Started Card — moved directly after hero */}
      <section className="mx-auto max-w-3xl px-5 pt-12 sm:px-8">
        <div className="rounded-3xl border-2 border-neon/40 bg-gradient-to-b from-card via-card/95 to-neon/10 p-8 shadow-[0_0_30px_rgba(var(--neon-color-rgb),0.15)] overflow-hidden relative">
